...
contract Bond is ERC721Enumerable, Ownable {
    ...
    //TODO: define thresholds, just for the SVG of the NFT.
    uint constant CATEGORY_1_THRESHOLD = 100 ether;
    uint constant CATEGORY_2_THRESHOLD = 1_000 ether;
    uint constant CATEGORY_3_THRESHOLD = 10_000 ether;
    ...
    function getCategory(uint256 _tokenId) public view returns(uint) {
        ...
        return dusdBondData.amount >= CATEGORY_3_THRESHOLD ? 3 : 
